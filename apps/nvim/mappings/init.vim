...
" General mappings
execute "source " . g:vim_dir . "/mappings/general.vim"
" Plugin specific mappings
execute "source " . g:vim_dir . "/mappings/plugins.vim"

" Layout specific mappings
execute "source " . g:vim_dir . "/mappings/dvorak.vim"
execute "source " . g:vim_dir . "/mappings/qwerty.vim"
execute "source " . g:vim_dir . "/mappings/set-mapping.vim"
